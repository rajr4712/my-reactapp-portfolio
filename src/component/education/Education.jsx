...
{/*loc48,49: if Education section true then qualification_content-active means show ho jo none hai and if false means we are in experience tab then content not show dts y qualification_content give where display none pass in css file me */}           
            ...
            {/*For Web devlopment degree */}
                          <div>
                             <h3 className="qualification_title">MERN Stack Web Devlopment</h3>
                                <span className="qualification_subtitle">CODE HELP</span>

                                <div className="qualification_calender">
                                <i class="uil uil-calendar-alt"></i>     {/*caleder font icon used*/}
                                    Dec 2022 - August 2023 </div>
                            </div>
                            
                             <div> {/* for round circle and vertical line */}
                      ...
                      {/* for Graduation degree */}
                        ...
                        <div className="special"></div>
                         ...
                         <h3 className="qualification_title">Bachelor of Science in Information Technology</h3>
                          <span className="qualification_subtitle">College of Commerce, Arts and Science, Patna</span>
                ...
                {/* for Intermediate degree */}
                        <div className="qualification_data">
                            ...
                            <div>
                                <h3 className="qualification_title">Intermediate in ISC(MATH)</h3>
                                <span className="qualification_subtitle">T.P.S College Patna</span>
                ...
                {/* for High School  Degree */}
                        ...
                        <div className="special"></div>
                            ...
                            <div>
                                ...
                                <span className="qualification_subtitle">S G G S HIGH SCHOOL PATNA CITY</span>
    ...
    {/*if Experience section is true then experience_content none ko active show if flase then display:none rhne de experience text ko dts y qualification_content class pass .check loc42,46 in css file*/}
                 ...
                 <div>
                      <h3 className="experience_title">Sorry 
